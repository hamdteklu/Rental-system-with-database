...
public class DBMethods
{
	...
	public void insertRental(double pricePerDay, int numberOfDays,int numberOfMiles,String carType,int passengers,int tonSize, String name)
	{
		...
		try
		{
			...
			insertRental = connection.prepareStatement("Insert into rental (pricePerDay, numberOfDays, numberOfMiles, carType, passengers, tonSize,name ) values (?,?,?,?,?,?,?)");

			insertRental.setDouble(1,pricePerDay);
			insertRental.setInt(2,numberOfDays);
			insertRental.setInt(3,numberOfMiles);
			insertRental.setString(4,carType);
			insertRental.setInt(5,passengers);
			insertRental.setInt(6,tonSize);
			insertRental.setString(7,name);
 ...
 public void DisplayRental() {
      ...
      final String DATABASE_URL = "jdbc:derby:rental";        
      final String SELECT_QUERY = "SELECT pricePerDay, numberOfDays, numberOfMiles, carType, passengers, tonSize FROM rental";
